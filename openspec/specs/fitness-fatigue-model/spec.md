# fitness-fatigue-model Specification

## Purpose
The Fitness vs. Fatigue model (CTL/ATL/TSB) provides a scientific way to track a user's long-term fitness, short-term fatigue, and overall readiness to perform (form). This model helps users optimize their training load and avoid overtraining or injury by identifying when they are pushing too hard or when they are well-rested.
